...
CREATE TABLE `OrderDetails` (
  ...
  CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE
...
INSERT INTO `OrderDetails` VALUES (1,1,102,1,130000.00,18.00),(2,1,101,1,70000.00,18.00),(3,3,103,1,20000.00,18.00),(4,2,104,5,1000.00,12.00);
